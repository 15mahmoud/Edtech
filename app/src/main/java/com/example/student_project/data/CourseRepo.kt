...
class CourseRepo {
    companion object {
        ...
        val trendingCourse = listOf(
            Course(1, "Advanced Front_End Programing Techniques", "www.vkmvk.com", 4.5, "mezo", 12.99),
            Course(2, "Ultimate CyberSecurity For Beginner", "www.vkmvk.com", 4.7, "mezo", 12.99),
